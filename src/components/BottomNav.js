...
const TABS = [
  ...
  { href: '/operations', label: '운영', icon: LayoutGrid, matches: ['/operations', '/schedule', '/handover', '/checklists', '/inventory', '/sales', '/announcements', '/equipment', '/recipes', '/complaints', '/reports', '/members'] },
